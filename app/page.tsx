...
/** Simple, stable page component (no tricky TS syntax) */
type Section =
  | 'Home'
  | 'Services'
  | 'Advisory'
...
export default function Page() {
  ...
  return (
    <main>
      ...
      <div className="grid-wrap" aria-hidden>
        ...
        <div
          ...
          style={{
            ...
            top: '-18rem',
            background:
              'radial-gradient(circle at 30% 30%, rgba(34,211,238,.55), rgba(139,92,246,.35) 55%, transparent 70%)',
            position: 'absolute',
          }}
        />
        <div
          ...
          style={{
            ...
            bottom: '-14rem',
            background:
              'radial-gradient(circle at 70% 70%, rgba(232,121,249,.45), rgba(56,189,248,.35) 50%, transparent 70%)',
            position: 'absolute',
          }}
        />
      </div>
          ...
          <nav>
            {items.map((k) => (
              <a
                key={k}
                onClick={() => {
                  // Home should show hero (not an overlay)
                  if (k === 'Home') setSection('Home');
                  else setSection(k);
                }}
              >
                {k}
      ...
      {isMobile && open && (
        <nav className="overlay" style={{ zIndex: 1000 }}>
          <div className="soft" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {items.map((k) => (
              <div key={k} style={{ padding: '.4rem 0' }}>
                <a
                  onClick={() => {
                    if (k === 'Home') setSection('Home');
                    else setSection(k);
      ...
      {/* HERO (shows when section === 'Home') */}
      {section === 'Home' && (
        <section className="section">
          <div className="container">
            <div className="soft">
              <h1 className="h1">Protecting Clients. Preserving Trust.</h1>
              <p style={{ opacity: 0.92, margin: '0 0 1rem' }}>
                Your firm’s reputation rests on confidentiality. We secure Microsoft 365 so every
                client interaction is protected — and every safeguard is backed by proof.
              </p>
              <div className="cards">
      ...
      {/* OVERLAYS (semi-transparent so grid/flares show through) */}
      {section === 'Services' && (
        <section className="section overlay">
          <div className="soft">
            ...
            <p>
              Insurers raise premiums. Regulators raise standards. We align your Microsoft 365 so you
              can <strong>prove control, reduce exposure, and negotiate from strength.</strong>
            </p>
            <ul>
              <li>Admin rights reduced; conditional access enforced</li>
              <li>Legacy auth blocked; extended audit logging enabled</li>
            ...
            <ul>
              ...
              <li>Malicious rules/connectors detected and removed</li>
              <li>End-to-end TLS validation; deliverability checks</li>
            </ul>
            ...
            <ul>
              <li>Immutable backups with versioning and legal holds</li>
              <li>Quarterly restore drills with signed evidence</li>
              <li>Retention aligned to discovery and peer-review cycles</li>
            </ul>
          </div>
        </section>
      )}
      ...
      {section === 'Advisory' && (
        <section className="section overlay">
          <div className="soft">
            ...
            <h3>💧 Lite Advisory</h3>
            <p>
              We keep your Microsoft 365 <strong>monitored, drift tracked, and evidence current.</strong>
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Commitment:</strong> Minimal — one admin account + a firm contact
              </li>
              <li>
                <strong>What You Get:</strong> Drift alerts, monitoring, binder evidence kept up to
                date
              </li>
            </ul>
            <p>
            ...
            <h3>📘 Plus Advisory</h3>
            <p>
              We run <strong>regular drills, reviews, and checks</strong> so your systems stay aligned
            ...
            <ul>
              ...
              <li>
                <strong>Commitment:</strong> Moderate — quarterly reviews, occasional staff input
              </li>
              <li>
                <strong>What You Get:</strong> Recovery drills, deliverability checks, policy updates
              </li>
            </ul>
            <p>
            ...
            <p>
              <strong>Priority support, board-level reporting, and regulator/insurer alignment.</strong>
            </p>
            <ul>
              <li>
                <strong>Support:</strong> Priority email + chat + on-demand remote sessions
              </li>
              <li>
                <strong>Commitment:</strong> High — monthly reviews, dedicated contact
              </li>
              <li>
                <strong>What You Get:</strong> Strategic reporting, insurer negotiation support,
                alignment maps
              </li>
            </ul>
          </div>
      ...
      {section === 'CPA' && (
        <section className="section overlay">
          <div className="soft">
            ...
            <p>
              <strong>Tax season isn’t forgiving.</strong> We harden Microsoft 365 so you can{' '}
            ...
            <p>
              <em>Outcome:</em> Even at peak season, your firm is compliant, covered, and client-ready.
            </p>
          </div>
        </section>
      )}
      ...
      {section === 'Law' && (
        <section className="section overlay">
          <div className="soft">
            ...
            <p>
              <strong>Confidentiality is everything.</strong> We secure Microsoft 365 so your firm can{' '}
            ...
            <p>
              <em>Outcome:</em> Your firm answers with evidence — not promises.
            </p>
          </div>
        </section>
      )}
        ...
        <section className="section overlay">
          <div className="soft">
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  <th style={{ textAlign: 'left', borderBottom: '1px solid #666' }}>The Risk</th>
                  <th style={{ textAlign: 'left', borderBottom: '1px solid #666' }}>Our Response</th>
                </tr>
              </thead>
              <tbody>
                <tr>
      ...
      {section === 'Get Started' && (
        <section className="section overlay">
          <div className="soft">
            ...
            <p>
              👉 <a href="https://outlook.office.com/book/JGSConsulting@cloudjgs.com/?ismsaljsauthenabled">Book a Call</a>{' '}
      ...
      {/* Footer shows with hero */}
      {section === 'Home' && (
        <footer className="footer">© {new Date().getFullYear()} JGS Cloud Compliance</footer>
      )}
    </main>
  );
}
