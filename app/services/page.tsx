  ...
  return (
    <section className="section container">
      ...
      <div className="card full">
        ...
        <p className="lead">
          One-time, flat-fee projects that close security gaps, restore confidence,
          and make your Microsoft 365 environment defensible and verifiable.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <p>
          Close internal access gaps, remove stale accounts, and enforce least-privilege control across your
          Microsoft 365 tenant.  We identify forgotten identities, admin sprawl, and conditional-access weaknesses
          that leave firms vulnerable.
        </p>
        <ul>
        ...
        <p style={{fontWeight:600}}>
          <strong>Result:</strong> Only the right people can sign in; leadership can demonstrate control to
      ...
      <div className="card">
        ...
        <p>
          Configure and validate SPF, DKIM, and DMARC so every message your firm sends is trusted,
          authenticated, and delivered the first time.
        </p>
        <ul>
        ...
        <p style={{fontWeight:600}}>
          <strong>Result:</strong> Clients, courts, and counterparties recognize authentic mail; impostors fail
          before reaching staff.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <p>
          Prove that your firm can recover data quickly and completely when disruption strikes.
          We test and document real restore performance across SharePoint, OneDrive, and Exchange Online.
        </p>
        <ul>
        ...
        <p style={{fontWeight:600}}>
          <strong>Result:</strong> Case files and client records are recoverable and auditable.
          Continuity evidence accepted by insurers.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <p>
          Each engagement ends with tangible proof: configuration evidence, screenshots, and a summary written for
      ...
      <div className="card full book-cta">
        ...
        <p className="lead">
          Start with a 30-minute consultation to review your environment, insurer requirements,
